...
func newBanner(db *gorm.DB, opts ...gen.DOOption) banner {
	...
	_banner.Name = field.NewString(tableName, "name")
	_banner.ImgPath = field.NewString(tableName, "img_path")
	_banner.StartAt = field.NewField(tableName, "start_at")
	_banner.EndAt = field.NewField(tableName, "end_at")
	_banner.AppPlat = field.NewInt64(tableName, "app_plat")
	_banner.Sort = field.NewInt64(tableName, "sort")
	_banner.Remark = field.NewString(tableName, "remark")
	_banner.IsOpen = field.NewInt64(tableName, "is_open")
	_banner.OperateAdminName = field.NewString(tableName, "operate_admin_name")
	_banner.Kind = field.NewInt64(tableName, "kind")
	_banner.CreatedAt = field.NewField(tableName, "created_at")
	_banner.UpdatedAt = field.NewField(tableName, "updated_at")
	_banner.PcJumpURL = field.NewString(tableName, "pc_jump_url")
	_banner.H5JumpURL = field.NewString(tableName, "h5_jump_url")
	_banner.IosJumpURL = field.NewString(tableName, "ios_jump_url")
	_banner.AndroidJumpURL = field.NewString(tableName, "android_jump_url")
...
type banner struct {
	...
	ImgPath          field.String // mobile版图片地址
	StartAt          field.Field  // 展示开始时间
	EndAt            field.Field  // 展示结束时间
	AppPlat          field.Int64  // 平台 1:综合 2:体育
	Sort             field.Int64  // 排序
	Remark           field.String // 备注
	IsOpen           field.Int64  // 状态
	OperateAdminName field.String // 操作管理员
	Kind             field.Int64  // 图片类型1:手机端;2:pc
	CreatedAt        field.Field
	UpdatedAt        field.Field
	PcJumpURL        field.String // PC端跳转地址
	H5JumpURL        field.String // h5跳转地址
	IosJumpURL       field.String // ios跳转地址
	AndroidJumpURL   field.String // 安卓跳转地址
...
func (b *banner) updateTableName(table string) *banner {
	...
	b.StartAt = field.NewField(table, "start_at")
	b.EndAt = field.NewField(table, "end_at")
	b.AppPlat = field.NewInt64(table, "app_plat")
	b.Sort = field.NewInt64(table, "sort")
	b.Remark = field.NewString(table, "remark")
	b.IsOpen = field.NewInt64(table, "is_open")
	b.OperateAdminName = field.NewString(table, "operate_admin_name")
	b.Kind = field.NewInt64(table, "kind")
	b.CreatedAt = field.NewField(table, "created_at")
	b.UpdatedAt = field.NewField(table, "updated_at")
	b.PcJumpURL = field.NewString(table, "pc_jump_url")
	b.H5JumpURL = field.NewString(table, "h5_jump_url")
	b.IosJumpURL = field.NewString(table, "ios_jump_url")
	b.AndroidJumpURL = field.NewString(table, "android_jump_url")
...
func (b *banner) WithContext(ctx context.Context) IBannerDo { return b.bannerDo.WithContext(ctx) }
...
func (b *banner) fillFieldMap() {
	...
	b.fieldMap["start_at"] = b.StartAt
	b.fieldMap["end_at"] = b.EndAt
	b.fieldMap["app_plat"] = b.AppPlat
	b.fieldMap["sort"] = b.Sort
	b.fieldMap["remark"] = b.Remark
	b.fieldMap["is_open"] = b.IsOpen
	b.fieldMap["operate_admin_name"] = b.OperateAdminName
	b.fieldMap["kind"] = b.Kind
	b.fieldMap["created_at"] = b.CreatedAt
	b.fieldMap["updated_at"] = b.UpdatedAt
	b.fieldMap["pc_jump_url"] = b.PcJumpURL
	b.fieldMap["h5_jump_url"] = b.H5JumpURL
	b.fieldMap["ios_jump_url"] = b.IosJumpURL
	b.fieldMap["android_jump_url"] = b.AndroidJumpURL
}
