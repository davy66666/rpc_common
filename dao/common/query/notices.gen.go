...
func newNotice(db *gorm.DB, opts ...gen.DOOption) notice {
	...
	_notice.Kind = field.NewInt64(tableName, "kind")
	_notice.Content = field.NewString(tableName, "content")
	_notice.Sort = field.NewInt64(tableName, "sort")
	_notice.OperateAdminName = field.NewString(tableName, "operate_admin_name")
	_notice.IsOpen = field.NewInt64(tableName, "is_open")
	_notice.AppPlat = field.NewInt64(tableName, "app_plat")
	_notice.CreatedAt = field.NewField(tableName, "created_at")
	_notice.UpdatedAt = field.NewField(tableName, "updated_at")
...
func (n *notice) updateTableName(table string) *notice {
	...
	n.Kind = field.NewInt64(table, "kind")
	n.Content = field.NewString(table, "content")
	n.Sort = field.NewInt64(table, "sort")
	n.OperateAdminName = field.NewString(table, "operate_admin_name")
	n.IsOpen = field.NewInt64(table, "is_open")
	n.AppPlat = field.NewInt64(table, "app_plat")
...
func (n *notice) fillFieldMap() {
	...
	n.fieldMap["operate_admin_name"] = n.OperateAdminName
	n.fieldMap["is_open"] = n.IsOpen
	n.fieldMap["app_plat"] = n.AppPlat
