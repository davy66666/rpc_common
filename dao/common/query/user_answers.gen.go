...
func newUserAnswer(db *gorm.DB, opts ...gen.DOOption) userAnswer {
	...
	_userAnswer.QuestionID = field.NewInt64(tableName, "question_id")
	_userAnswer.Question = field.NewString(tableName, "question")
	_userAnswer.Answer = field.NewString(tableName, "answer")
	_userAnswer.CreatedAt = field.NewField(tableName, "created_at")
	_userAnswer.UpdatedAt = field.NewField(tableName, "updated_at")
...
func (u *userAnswer) updateTableName(table string) *userAnswer {
	...
	u.QuestionID = field.NewInt64(table, "question_id")
