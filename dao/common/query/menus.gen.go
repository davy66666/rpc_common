...
func newMenu(db *gorm.DB, opts ...gen.DOOption) menu {
	...
	_menu.Code = field.NewString(tableName, "code")
	_menu.ParentID = field.NewInt64(tableName, "parent_id")
	_menu.IsShow = field.NewInt64(tableName, "is_show")
	_menu.CreatedAt = field.NewField(tableName, "created_at")
	_menu.UpdatedAt = field.NewField(tableName, "updated_at")
	_menu.OperateAdminName = field.NewString(tableName, "operate_admin_name")
...
func (m *menu) updateTableName(table string) *menu {
	...
	m.IsShow = field.NewInt64(table, "is_show")
	m.CreatedAt = field.NewField(table, "created_at")
	m.UpdatedAt = field.NewField(table, "updated_at")
	m.OperateAdminName = field.NewString(table, "operate_admin_name")
...
func (m *menu) fillFieldMap() {
	...
	m.fieldMap["operate_admin_name"] = m.OperateAdminName
