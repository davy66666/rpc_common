...
func newSysConfig(db *gorm.DB, opts ...gen.DOOption) sysConfig {
	...
	_sysConfig.Plat = field.NewInt64(tableName, "plat")
	_sysConfig.Title = field.NewString(tableName, "title")
	_sysConfig.K = field.NewString(tableName, "k")
	_sysConfig.Val = field.NewString(tableName, "val")
	_sysConfig.Remark = field.NewString(tableName, "remark")
	_sysConfig.IsOpen = field.NewInt64(tableName, "is_open")
	_sysConfig.IsMuti = field.NewInt64(tableName, "is_muti")
	_sysConfig.CreatedAt = field.NewField(tableName, "created_at")
	_sysConfig.UpdatedAt = field.NewField(tableName, "updated_at")
	_sysConfig.AdminName = field.NewString(tableName, "admin_name")
	_sysConfig.SysSettingType = field.NewInt64(tableName, "sys_setting_type")
...
type sysConfig struct {
	...
	ALL            field.Asterisk
	ID             field.Int64
	Plat           field.Int64  // 终端;1:手机端;4:pc
	Title          field.String // 配置名称
	K              field.String // 下标
	Val            field.String // 值
	Remark         field.String // 备注
	IsOpen         field.Int64  // 是否启用
	IsMuti         field.Int64  // 编辑类型 0富文本 1多行
	CreatedAt      field.Field
	UpdatedAt      field.Field
	AdminName      field.String
	SysSettingType field.Int64 // 系统配置类型
...
func (s *sysConfig) updateTableName(table string) *sysConfig {
	...
	s.Plat = field.NewInt64(table, "plat")
	s.Title = field.NewString(table, "title")
	s.K = field.NewString(table, "k")
	s.Val = field.NewString(table, "val")
	s.Remark = field.NewString(table, "remark")
	s.IsOpen = field.NewInt64(table, "is_open")
	s.IsMuti = field.NewInt64(table, "is_muti")
	...
	s.SysSettingType = field.NewInt64(table, "sys_setting_type")
