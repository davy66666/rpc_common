...
func newSeries(db *gorm.DB, opts ...gen.DOOption) series {
	...
	_series.CnName = field.NewString(tableName, "cn_name")
	_series.EnName = field.NewString(tableName, "en_name")
	_series.Sort = field.NewInt64(tableName, "sort")
	_series.IsOpen = field.NewInt64(tableName, "is_open")
	_series.CreatedAt = field.NewField(tableName, "created_at")
	_series.UpdatedAt = field.NewField(tableName, "updated_at")
