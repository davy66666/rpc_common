...
const TableNameTransactionsCopy1 = "transactions_copy1"

// TransactionsCopy1 mapped from table <transactions_copy1>
...
// TableName TransactionsCopy1's table name
func (*TransactionsCopy1) TableName() string {
	return TableNameTransactionsCopy1
}
