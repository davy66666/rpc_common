...
const TableNameUserGameBetAmount = "user_game_bet_amounts"
...
// TableName UserGameBetAmount's table name
func (*UserGameBetAmount) TableName() string {
	return TableNameUserGameBetAmount
}
