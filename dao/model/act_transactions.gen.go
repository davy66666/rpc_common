...
const TableNameActTransaction = "act_transactions"

// ActTransaction mapped from table <act_transactions>
...
// TableName ActTransaction's table name
func (*ActTransaction) TableName() string {
	return TableNameActTransaction
}
