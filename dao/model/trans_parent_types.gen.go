...
const TableNameTransParentType = "trans_parent_types"

// TransParentType mapped from table <trans_parent_types>
...
// TableName TransParentType's table name
func (*TransParentType) TableName() string {
	return TableNameTransParentType
}
